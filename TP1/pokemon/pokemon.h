...
char * p_get_nome (Pokemon *p);     //char * retorna um ponteiro apontando para o primeiro elemento do vetor de strings quwe armazena o nome do pokemomn

char * p_get_tipo (Pokemon *p);

Coordenada p_get_localizacao(Pokemon *p);

float p_get_localizacao_x(Pokemon *p);   //mudei de int para float

float p_get_localizacao_y(Pokemon *p);  //mudei de int para float
